...
public class EntityPublicationLocalServiceUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(EntityPublicationLocalService.class);

		ServiceTracker<EntityPublicationLocalService, EntityPublicationLocalService> serviceTracker =
			new ServiceTracker<EntityPublicationLocalService, EntityPublicationLocalService>(bundle.getBundleContext(),
				EntityPublicationLocalService.class, null);
