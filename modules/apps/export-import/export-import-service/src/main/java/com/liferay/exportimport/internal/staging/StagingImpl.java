...
public class StagingImpl implements Staging {
	...
	/**
	 * @deprecated As of Judson (7.1.x), (7.1.x), replaced by {@link
	...
	/**
	 * @deprecated As of Judson (7.1.x), (7.1.x), moved to {@link
	...
	/**
	 * @deprecated As of Judson (7.1.x), (7.1.x), see {@link
	...
	/**
	 * @deprecated As of Judson (7.1.x), (7.1.x), with no direct replacement
	 */
	@Deprecated
	...
	/**
	 * @deprecated As of Judson (7.1.x), (7.1.x)
	 */
	@Deprecated
