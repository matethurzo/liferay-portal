...
public class ChangesetEntryLocalServiceWrapper
	...
	*/
	...
	@Override
	public com.liferay.changeset.model.ChangesetEntry addChangesetEntryIfNotExists(
		long changesetCollectionId, long classNameId, long classPK)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _changesetEntryLocalService.addChangesetEntryIfNotExists(changesetCollectionId,
			classNameId, classPK);
	}
