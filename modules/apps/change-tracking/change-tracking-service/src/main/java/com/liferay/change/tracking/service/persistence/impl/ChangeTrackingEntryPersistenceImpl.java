...
public class ChangeTrackingEntryPersistenceImpl extends BasePersistenceImpl<ChangeTrackingEntry>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C = new FinderPath(ChangeTrackingEntryModelImpl.ENTITY_CACHE_ENABLED,
			ChangeTrackingEntryModelImpl.FINDER_CACHE_ENABLED,
			ChangeTrackingEntryImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_C = new FinderPath(ChangeTrackingEntryModelImpl.ENTITY_CACHE_ENABLED,
			ChangeTrackingEntryModelImpl.FINDER_CACHE_ENABLED,
			ChangeTrackingEntryImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_C",
			new String[] { Long.class.getName(), Long.class.getName() },
			ChangeTrackingEntryModelImpl.CLASSNAMEID_COLUMN_BITMASK |
			ChangeTrackingEntryModelImpl.CLASSPK_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_C = new FinderPath(ChangeTrackingEntryModelImpl.ENTITY_CACHE_ENABLED,
			ChangeTrackingEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_C",
			new String[] { Long.class.getName(), Long.class.getName() });

	/**
	 * Returns all the change tracking entries where classNameId = &#63; and classPK = &#63;.
	 *
	 ...
	 */
	@Override
	public List<ChangeTrackingEntry> findByC_C(long classNameId, long classPK) {
		return findByC_C(classNameId, classPK, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the change tracking entries where classNameId = &#63; and classPK = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link ChangeTrackingEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the change tracking entries where classNameId = &#63; and classPK = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link ChangeTrackingEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<ChangeTrackingEntry> findByC_C(long classNameId, long classPK,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (ChangeTrackingEntry changeTrackingEntry : list) {
					if ((classNameId != changeTrackingEntry.getClassNameId()) ||
							(classPK != changeTrackingEntry.getClassPK())) {
						list = null;
	...
	/**
	 * Returns the first change tracking entry in the ordered set where classNameId = &#63; and classPK = &#63;.
	 *
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public ChangeTrackingEntry findByC_C_First(long classNameId, long classPK,
		OrderByComparator<ChangeTrackingEntry> orderByComparator)
		throws NoSuchEntryException {
		ChangeTrackingEntry changeTrackingEntry = fetchByC_C_First(classNameId,
	 ...
	 */
	@Override
	public ChangeTrackingEntry fetchByC_C_First(long classNameId, long classPK,
		OrderByComparator<ChangeTrackingEntry> orderByComparator) {
		List<ChangeTrackingEntry> list = findByC_C(classNameId, classPK, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last change tracking entry in the ordered set where classNameId = &#63; and classPK = &#63;.
	 *
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public ChangeTrackingEntry findByC_C_Last(long classNameId, long classPK,
		OrderByComparator<ChangeTrackingEntry> orderByComparator)
		throws NoSuchEntryException {
		ChangeTrackingEntry changeTrackingEntry = fetchByC_C_Last(classNameId,
				classPK, orderByComparator);
	 ...
	 */
	@Override
	public ChangeTrackingEntry fetchByC_C_Last(long classNameId, long classPK,
		OrderByComparator<ChangeTrackingEntry> orderByComparator) {
		...
		List<ChangeTrackingEntry> list = findByC_C(classNameId, classPK,
				count - 1, count, orderByComparator);
	...
	/**
	 * Returns the change tracking entries before and after the current change tracking entry in the ordered set where classNameId = &#63; and classPK = &#63;.
	 *
	 * @param changeTrackingEntryId the primary key of the current change tracking entry
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 ...
	 */
	@Override
	public ChangeTrackingEntry[] findByC_C_PrevAndNext(
		long changeTrackingEntryId, long classNameId, long classPK,
		OrderByComparator<ChangeTrackingEntry> orderByComparator)
		throws NoSuchEntryException {
		ChangeTrackingEntry changeTrackingEntry = findByPrimaryKey(changeTrackingEntryId);
		...
		try {
			...
			array[0] = getByC_C_PrevAndNext(session, changeTrackingEntry,
					classNameId, classPK, orderByComparator, true);

			array[1] = changeTrackingEntry;

			array[2] = getByC_C_PrevAndNext(session, changeTrackingEntry,
	...
	protected ChangeTrackingEntry getByC_C_PrevAndNext(Session session,
		ChangeTrackingEntry changeTrackingEntry, long classNameId,
		long classPK, OrderByComparator<ChangeTrackingEntry> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the change tracking entries where classNameId = &#63; and classPK = &#63; from the database.
	 *
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 */
	...
	public void removeByC_C(long classNameId, long classPK) {
		for (ChangeTrackingEntry changeTrackingEntry : findByC_C(classNameId,
	...
	/**
	 * Returns the number of change tracking entries where classNameId = &#63; and classPK = &#63;.
	 *
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 * @return the number of matching change tracking entries
	...
	private static final String _FINDER_COLUMN_C_C_CLASSNAMEID_2 = "changeTrackingEntry.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_C_CLASSPK_2 = "changeTrackingEntry.classPK = ?";
	...
	public ChangeTrackingEntry updateImpl(
		...
		if (!ChangeTrackingEntryModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] {
					changeTrackingEntryModelImpl.getClassNameId(),
					changeTrackingEntryModelImpl.getClassPK()
				};
			...
			if ((changeTrackingEntryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						changeTrackingEntryModelImpl.getOriginalClassNameId(),
						changeTrackingEntryModelImpl.getOriginalClassPK()
					};
