...
/**
 * The extended model implementation for the CTEChangeEntry service. Represents
 * a row in the &quot;CTEChangeEntry&quot; database table, with each column
 * mapped to a property of this class.
 *
 * <p>
 * Helper methods and all application logic should be put in this class.
 * Whenever methods are added, rerun ServiceBuilder to copy their definitions
 * into the {@link com.liferay.change.tracking.engine.model.CTEChangeEntry}
 * interface.
 * </p>
 *
...
public class CTEChangeEntryImpl extends CTEChangeEntryBaseImpl {
	 ...
	 * com.liferay.change.tracking.engine.model.CTEChangeEntry} interface
	 * instead.
	 */
