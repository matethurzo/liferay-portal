...
/**
 * The base model interface for the CTEChangeEntry service. Represents a row in the &quot;CTEChangeEntry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.liferay.change.tracking.engine.model.impl.CTEChangeEntryModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.liferay.change.tracking.engine.model.impl.CTEChangeEntryImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface CTEChangeEntryModel extends AttachedModel, AuditedModel,
	BaseModel<CTEChangeEntry>, ResourcedModel, ShardedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a cte change entry model instance should use the {@link CTEChangeEntry} interface instead.
	 */
