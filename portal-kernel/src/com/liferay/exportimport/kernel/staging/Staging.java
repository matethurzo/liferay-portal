...
public interface Staging {
	...
	/**
	 * @deprecated As of Wilberforce (7.0.x), (7.0.x), replaced by {@link
	...
	/**
	 * @deprecated As of Wilberforce (7.0.x), (7.0.x), moved to {@link
	...
	/**
	 * @deprecated As of Wilberforce (7.0.x), (7.0.x), see {@link
